...
const SESOrder = ({ errMsg, projectType, isEdit, id }) => {
    ...
    if(projectCreateSESOrderState?.sesDeliveryDate) {
        parsedDeliveryDate = parseISO((new Date(projectCreateSESOrderState?.sesDeliveryDate)).toISOString())
    ...
    if(projectCreateSESOrderState?.sesAcceptanceBillingDate) {
        parsedAcceptanceDate = parseISO((new Date(projectCreateSESOrderState?.sesAcceptanceBillingDate)).toISOString())
    ...
    if(projectCreateSESOrderState?.sesPaymentDate) {
        parsedPaymentDate = parseISO((new Date(projectCreateSESOrderState?.sesPaymentDate)).toISOString())
            ...
            <div className="flex w-80 flex-col">
                <div className="z-10 mb-4 space-y-2">
                    ...
                    <Controller
                        ...
                        control={control}
                        defaultValue={projectCreateSESOrderState?.sesProjectLeader || ''}
                        render={({ field }) => (
                            <Combobox
                                value={projectLeader || ''}
